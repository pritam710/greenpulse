...
const pages = {
  ...
  cookies: {
    ...
    sections: [
      ...
      ['Third-party connections', <p key="third">OpenStreetMap tile servers receive requests needed to draw maps and may see technical data such as your IP address and requested map area. GitHub Pages and Render may keep their own operational and security logs. When you explicitly run AI-assisted segregation, the GreenPulse backend sends the selected photos and description to the Google Gemini API; Gemini is not embedded in the page and does not set a GreenPulse browser cookie. GreenPulse does not control those providers' logs or independent processing.</p>],
