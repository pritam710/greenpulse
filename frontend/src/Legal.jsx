...
const pages = {
  privacy: {
    ...
    sections: [
      ['Who operates this pilot', <p key="operator">GreenPulse is a student project led by <strong>Pritam Rathod</strong> in Maharashtra, India. It is not an official Government of India or municipal website. Contact the project team through the <a href="https://github.com/pritam710/greenpulse/issues" target="_blank" rel="noreferrer">GreenPulse project issue tracker</a>. Do not post passwords, personal photos, or sensitive information in a public issue.</p>],
